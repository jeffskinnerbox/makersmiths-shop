...
I plan to use Slidev and Excalidraw tools to create and display my presentation.
You should uses the excalidraw-diagram skill and the slidev skill.

1. Uses the excalidraw-diagram skill:
...
* Place the files you create in @presentations/requirements-review/diagrams/.
* From the .excalidraw files, create .png and .svg files and place them in @presentations/requirements-review/assets/.

2. Uses the slidev skill:
* Read the @docs/requirements.md document and create a presentation that reviews all the major section in the document.
